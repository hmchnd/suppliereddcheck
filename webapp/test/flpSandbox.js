		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ethical due diligence check",
									"targetURL": "#comsapsuppliereddcheck-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapsuppliereddcheck-display": {
								"semanticObject": "comsapsuppliereddcheck",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.suppliereddcheck",
									"url": sap.ui.require.toUrl("com/sap/suppliereddcheck")
								}
							}
						}
					}
